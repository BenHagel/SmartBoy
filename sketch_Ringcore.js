//To defeat the top down approach to modern machine learning.
// A ground up approach that optimizes how processing units interact with each other
//XOR problem is good for testing back propogation
//What problem is good for testing neuro transmitter callibration

//(Neuro transmitters) are necessary to maintain states of neurons
var canvasInstance;
...
function setup(){
	...
	1) want to be able to run in time
	2) environment time frame
	3) input tool to design inputs in the correct time frame.

	4) neuron gene design
	5) 
	*/
	//Test the std nn
	let net = new StdNn({
